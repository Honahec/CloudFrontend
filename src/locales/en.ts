const en = {
  ...
  auth: {
    // New i18n keys per unified Auth Split View
    brand: 'Cloud',
    toggle: {
    ...
    login: {
      ...
      submit: 'Sign in',
      // Keep legacy placeholders for compatibility with existing forms
    ...
    register: {
      ...
      username: 'Username',
      usernameError: 'Please enter 3-20 characters (letters, numbers, . _ -)',
      email: 'Email',
    ...
    // Legacy section maintained for backward compatibility
    common: {
